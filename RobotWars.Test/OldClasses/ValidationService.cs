...
namespace RobotWars.Test.RobotTests
{
    class ValidationService
    {
        ...
        public  bool IsArenaDimensionValid(bool throwException, string input)
        {
        ...
        public bool IsInputValidLocation(string input)
        {
            if (IsStringArgumentNullOrEmpty(false, input))
            {
                return false;
        ...
        public bool IsInputValidMoveInstruction(string input)
        {
            if (IsStringArgumentNullOrEmpty(false, input))
            {
                return false;
